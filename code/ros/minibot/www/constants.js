...
//		BackgroundColor :  ["#F7F8F9", "#F1F3F5", "#222222" , "#ADB5BD", "#ECF0F1", "#FFFFFF" , "#F8F9FA", "#FFFFFF", "#FFFFFF" , "#FFFFFF", "#F9F8FC", "#F8F5F0" , "#FFFFFF", "#ECF0F1", "#FDF6E3", "#EEEEEE", "#ABB6C2", "#E9ECEF", "#2A3E51"  ]
//}


Constants.Themes = {
		Name : [ "cerulan", "cyborg", "darkly",  "sandstone", "simplex", "slate" ],
		Description : [ "A calm blue sky",  "Jet black", "Night mode", "Touch of warmth", "Minimalist", "Shades of gunmetal" ],
		BackgroundColor :  ["#F7F8F9",  "#222222" , "#ADB5BD",  "#F8F5F0" , "#FFFFFF", "#ECF0F1"  ]
}
