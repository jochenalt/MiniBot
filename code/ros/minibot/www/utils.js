...
Utils.readConfiguration = function(callbackSuccess, callbackFailure) {
    var request = new ROSLIB.ServiceRequest({
     action : Constants.READ_CONFIGURATIION,
    });
...
Utils.writeConfiguration = function(configuration, callbackSuccess, callbackFailure) {
    var request = new ROSLIB.ServiceRequest({
     action : Constants.READ_CONFIGURATIION,
    });
