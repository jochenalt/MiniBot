...
TrapVelocityProfile::TrapVelocityProfile(double max_vel, double max_acc, double max_dec)
...
void TrapVelocityProfile::SetProfile(double pos1, double pos2)
{
  start_pos_ = pos1;
  end_pos_ = pos2;
  start_vel_ = 0.0;
...
void TrapVelocityProfile::SetProfileDuration(double pos1, double pos2, double duration)
{
...
bool TrapVelocityProfile::setProfileAllDurations(double pos1, double pos2, double duration1,
...
bool TrapVelocityProfile::setProfileStartVelocity(double pos1, double pos2, double vel1)
{
  if(vel1 == 0)
  {
    SetProfile(pos1,pos2);
...
double TrapVelocityProfile::Duration() const
{
  return t_a_ + t_b_ + t_c_;
}

double TrapVelocityProfile::Pos(double time) const
{
  if (time<0)
  {
    return start_pos_;
...
double TrapVelocityProfile::Vel(double time) const
{
  if (time<0)
  {
    return start_vel_;
...
double TrapVelocityProfile::Acc(double time) const
{
  if (time<=0)
  {
    return 0;
...
KDL::VelocityProfile* TrapVelocityProfile::Clone() const
{
  TrapVelocityProfile* trap = new TrapVelocityProfile(max_vel_, max_acc_, max_dec_);
...
void TrapVelocityProfile::Write(std::ostream &os) const
{
  os << *this;
}

std::ostream &operator<<(std::ostream &os, const TrapVelocityProfile &p)
{
...
bool TrapVelocityProfile::operator==(const TrapVelocityProfile& other) const
{
...
TrapVelocityProfile::~TrapVelocityProfile()
{

}

void TrapVelocityProfile::setEmptyProfile()
{
  a1_ = end_pos_;
  a2_ = 0;
  a3_ = 0;
