/*
 * trap_velocity_profile.h
 *
 *  Created on: Jun 20, 2020
 *      Author: jochen
 */

#ifndef INCLUDE_TRAP_VELOCITY_PROFILE_H_
#define INCLUDE_TRAP_VELOCITY_PROFILE_H_
 ...
 */
class TrapVelocityProfile : public KDL::VelocityProfile
{
public:
  /**
   * @brief Constructor
   ...
   */
  TrapVelocityProfile(double max_vel = 0, double max_acc = 0, double max_dec = 0);
   ...
   */
  bool operator==(const TrapVelocityProfile& other) const;
  ...
  friend std::ostream &operator<<(std::ostream& os, const TrapVelocityProfile& p); //LCOV_EXCL_LINE

  virtual ~TrapVelocityProfile();
...
std::ostream &operator<<(std::ostream& os, const TrapVelocityProfile& p);//LCOV_EXCL_LINE

}
}


#endif /* INCLUDE_TRAP_VELOCITY_PROFILE_H_ */
